...
function g_alert(type,cont,url){
	...
	//类型为alert
	if(type == 'success'){
		$('#g_cont img').attr('src','/assets/img/tip/ok.png');
		$('#false').hide();
	}
	if(type == 'error'){
		$('#g_cont img').attr('src','/assets/img/tip/fail.png');
		$('#false').hide();
	}
	//类型为confirm
	if(type == 'warn'){
		$('#g_cont img').attr('src','/assets/img/tip/warn.jpg');
		$('#false').hide();
	}
	//类型为confirm
	if(type == 'confirm'){
		$('#g_cont img').attr('src','/assets/img/tip/confirm.jpg');
	}
	//点击OK
	$('#ok').click(function(){
		$('#g_all').remove();
